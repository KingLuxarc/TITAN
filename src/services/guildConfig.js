...
const GUILD_CONFIG_DEFAULTS = {
    prefix: BotConfig.prefix, modRole: null, adminRole: null, botAccessRoles: [], welcomeChannel: null,
    welcomeMessage: 'Welcome {user} to {server}!', autoRole: null, dmOnClose: true, disabledCommands: {}, disabledCategories: {},
